...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 10 mars 2021 à 08:57
...
INSERT INTO `matchs` (`num_match`, `num_salle`, `date_match`, `heure_match`, `num_equipe1_`, `num_equipe_2`, `num_arbitre_p`, `num_arbitre_s`, `montant_déplt_p`, `montant_déplt_s`) VALUES
...
(1, '$2y$10$kXXmwy9JpT4exp.zI75Ev.v/dtpVRu/R/cvH5Ou8sH.', 'test@test.com', 'test', 'test', '2021-03-24');
...
ALTER TABLE `matchs`
  ...
  ADD CONSTRAINT `matchs_ibfk_4` FOREIGN KEY (`num_equipe1_`) REFERENCES `equipe` (`num_equipe`) ON DELETE CASCADE ON UPDATE CASCADE,
